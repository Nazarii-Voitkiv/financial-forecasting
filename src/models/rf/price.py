...
def main():
    parser = argparse.ArgumentParser(description="Random Forest dla USD/PLN — wartość 2025")
    ...
    if args.walk_forward:
        y_pred, y_true = walk_forward_predict_2025(close, X, y, args.n_est, args.max_depth, args.seed)
    else:
        y_pred, y_true, _ = train_once_predict_2025(close, X, y, args.n_est, args.max_depth, args.seed)
    acc, desc = evaluate_tolerance(y_true, y_pred, args.tol_abs, args.tol_pct)
